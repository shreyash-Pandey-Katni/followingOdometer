...
var _Object = /*#__PURE__*/function () {
  function Object(x, y, radius, color, offset) {
...
function init() {
  ...
  for (var i = 0; i < 400; i++) {
    objects.push(new _Object(canvas.width / 2 + i, canvas.height / 2, 30 * (400 - i) / 400, "hsl(".concat(i * 360 / 400, ", 50%, 50%)"), i)); // objects.push()
  }
} // Animation Loop
...
function animate() {
  ...
  var tan = (objects[0].y - mouse.y) / (objects[0].x - mouse.x);
  angle = Math.atan2(mouse.y, mouse.x); // c.fillText('HTML CANVAS BOILERPLATE', mouse.x, mouse.y)
